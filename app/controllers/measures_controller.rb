class MeasuresController < ApplicationController
  def extract_data
    ...
    @data_tmp_room_8a  = []
    @data_voct_room_8a  = []
    @data_room_8a_room_8a  = @measure_room_8a['measure_type'].each do |tab|
      @data_keys  << @measure_room_8a['@timestamp'][i].to_datetime.to_i
      case tab
      when 'CO2'
    ...
    @data_tmp_room_8f = []
    @data_voct_room_8f = []
    @data_room_8f = @measure_room_8f['measure_type'].each do |tab|
      @data_keys << @measure_room_8f['@timestamp'][x].to_datetime.to_i
      case tab
      when 'CO2'
    ...
    @data_tmp_room_b2 = []
    @data_voct_room_b2 = []
    @data_room_b2 = @measure_room_b2['measure_type'].each do |tab|
      @data_keys << @measure_room_b2['@timestamp'][y].to_datetime.to_i
      # binding.pry
      case tab
      when 'CO2'
